...
if __name__ == "__main__":
    ...
    parser.add_argument('--gym-id', type=str, default="ALE/MsPacman-v5",
    ...
    parser.add_argument('--v-max', type=float, default=10,
                        help="the number of atoms")
    parser.add_argument('--buffer-size', type=int, default=10000, # 1000000
    ...
    parser.add_argument("--path", type=str, default=None, help="the path to save model")
...
run_name = f"{args.gym_id}"

args.path = 'runs/' + run_name
...
for global_step in range(args.total_timesteps):
    ...
    torch.save(q_network.state_dict(),args.path+'/checkpoint.pt')
